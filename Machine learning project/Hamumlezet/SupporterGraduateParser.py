...
def get_given_in_semester(txt: list) -> dict[str:bool]:
...
def get_exams_dates(course_soup) -> dict[dict[SEASON or None, DAYS or None,
                                              datetime.date or None, datetime.time or None] or None] or None:
...
def get_given_in_semester_and_credit_point(course_soup: BeautifulSoup) -> (float, dict[str:bool]):
