...
class CatalogParser(Singleton):
    def __init__(self):
        self.__id_list = ["104031", "104166", "234114", "234129", "324033", "104032", "114071", "234124", "234247",
                          ...
                          '094313', '094325', '094334', '094423', '094591', '096224', '096250',
        ...
        self.__three_year_degree_requirements_by_type = {
            ...
            COURSES_TYPES[7]: ['044105', '044127', '044131', '044137', '044157', '044167', '044169',
                               '044202', '046201', '046206', '046332', '046880', '048878', '048921', '086761', '094222',
                               '094313', '094333', '094325', '094334', '094423', '094591', '096224', '096250',
                               '096262', '096326', '096411', '097317', '104122', '104135', '104142', '104157', '104165',
        ...
        self.__three_year_degree_requirements_by_subtype = {
            "שרשרת מדעית":
                {
                    COURSES_SUBTYPES[0]: ['114075'],
                    COURSES_SUBTYPES[1]: ['114052', '114054'],
                    COURSES_SUBTYPES[2]: ['134058', '134020'],
                    COURSES_SUBTYPES[3]: ['124120', '125801'],
                    COURSES_SUBTYPES[4]: ['124510'],
                    COURSES_SUBTYPES[5]: ['124120', '114052']
                }
        }
    ...
    @staticmethod
    def get_instance():
        if CatalogParser._instance is None:
            raise Exception("CatalogParser instance does not exist")
        return CatalogParser._instance

    def get_three_year_degree_requirements_credit_points(self) -> dict[COURSES_TYPES, float]:
        return self.__three_year_degree_requirements_credit_points

    def get_id_courses_sorted_by_courses_type(self) -> dict[COURSES_TYPES, list[str]]:
        return self.__three_year_degree_requirements_by_type

    def get_id_courses_sorted_by_courses_subtype(self) -> dict[COURSES_TYPES, dict[COURSES_SUBTYPES, list[str]]]:
    ...
    def delete_instance(cls):
        cls.__id_list = None
        cls.__three_year_degree_requirements_by_type = None
        cls.__three_year_degree_requirements_by_subtype = None
        cls.__three_year_degree_requirements_credit_points = None
