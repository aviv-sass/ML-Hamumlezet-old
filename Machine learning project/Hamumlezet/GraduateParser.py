...
class GraduateParser(Singleton):
    ...
    def __new__(cls, catalog_parser=None, json_file_path=None, courses_test=False, internet_access=bool):
        if cls._instance is None:
            ...
            cls._instance.__courses_dict = None
            cls._instance.__linked_courses_dict = None
    ...
    def __init__(self, json_file_path: str or None, catalog_parser: CatalogParser or None,
        ...
        if GraduateParser._instance is not None:
            GraduateParser._instance = self

    @staticmethod
    def get_instance():
        if GraduateParser._instance is None:
            raise Exception("GraduateParser instance does not exist")
        return GraduateParser._instance
    ...
    def delete_instance(cls):
        cls.__courses_dict = None
        cls.__linked_courses_dict = None
        cls.__catalog_parser = None
